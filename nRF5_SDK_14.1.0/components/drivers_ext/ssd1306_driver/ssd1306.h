...
typedef int8_t (*oled_ssd1306_com_fptr_t)(uint8_t dev_addr, uint8_t reg_addr,
		uint8_t *data, uint16_t len);

typedef void (*oled_ssd1306_delay_fptr_t)(uint32_t period);
...
typedef struct{
	...
	oled_ssd1306_com_fptr_t read;
	/*! Write function pointer */
	oled_ssd1306_com_fptr_t write;
	/*!  Delay function pointer */
	oled_ssd1306_delay_fptr_t delay_ms;
